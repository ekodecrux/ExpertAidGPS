...
async function start() {
  ...
  try {
    firestoreDb = firebaseConfig.firestoreDatabaseId ? (0, import_firestore.getFirestore)(void 0, firebaseConfig.firestoreDatabaseId) : (0, import_firestore.getFirestore)();
    try {
